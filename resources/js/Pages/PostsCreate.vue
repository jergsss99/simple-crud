                ...
                <form @submit.prevent="save">
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-4"  placeholder="Enter Title" v-model="form.title" required>
                            <textarea type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-4"  placeholder="Enter Body" v-model="form.body" required rows="4">
                            </textarea>
...
export default {
    ...
    methods: {
            ...
            save () {
                axios.post(this.route('posts-api.store'),this.form)
                    .then(response =>{
                    this.showAlert=true,
                    this.errors = null;
                    })
